...
def show_cfg(cfg):
    ...
    cfg_str = dump_cfg.dump()
    log_str = log_msg("CONFIG:\n{}".format(cfg_str), "INFO")
    print(log_str)
    return cfg_str
...
CFG.EXPERIMENT.LAMBDA_THRESHOLD = 0.9
CFG.EXPERIMENT.TEMPERATURE_LR = 0.25
CFG.EXPERIMENT.ADAPTIVE_TEMPERATURE = False
CFG.EXPERIMENT.LOG_FILE_PATH = ""
...
CFG.DKD.BETA = 8.0
CFG.DKD.T = 4.0
CFG.DKD.T_WEIGHT = 4.0
CFG.DKD.WARMUP = 20

# LSKD CFG
CFG.LSKD = CN()
CFG.LSKD.TEMPERATURE = 2
CFG.LSKD.TEMPERATURE_WEIGHT = 2
CFG.LSKD.LOSS = CN()
CFG.LSKD.LOSS.CE_WEIGHT = 0.1
CFG.LSKD.LOSS.KD_WEIGHT = 9

# ABKD CFG
CFG.ABKD = CN()
CFG.ABKD.TEMPERATURE = 4
CFG.ABKD.ALPHA = 0.8
CFG.ABKD.BETA = 0.3
CFG.ABKD.LOSS = CN()
CFG.ABKD.LOSS.CE_WEIGHT = 1
CFG.ABKD.LOSS.KD_WEIGHT = 64
